...
export const getWorkflowName = (
    context: Context<'workflow_run'> | Context<'workflow_run.requested'> | Context<'workflow_run.completed'>
): string => {
...
export const getWorkflowRunConclusion = (context: Context<'workflow_run.completed'>) => {
...
): context is Context<'workflow_run' | 'workflow_run.completed' | 'workflow_run.requested'> => {
